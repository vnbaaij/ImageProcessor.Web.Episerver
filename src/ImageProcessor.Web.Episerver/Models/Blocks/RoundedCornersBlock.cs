...
{
    [ContentType(DisplayName = "Rounded Corners", GUID = "60b84172-12a5-4987-88c4-c285381d9ceb", Description = "Adds rounded corners to the current image.", GroupName = Global.GroupName)]
