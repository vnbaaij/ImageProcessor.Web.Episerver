...
{
    [ContentType(DisplayName = "Pixelate", GUID = "9f61b2b0-0e12-46c5-95f8-4058adcb45b5", Description = "Pixelates an image with the given size.", GroupName = Global.GroupName)]
