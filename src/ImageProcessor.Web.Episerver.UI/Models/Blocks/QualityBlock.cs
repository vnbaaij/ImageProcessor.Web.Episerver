...
{
    [ContentType(DisplayName = "Quality", GUID = "cc0e4ad4-d3ee-467e-877f-7cf7f4a50db8", Description = "Alters the output quality of the current image.", GroupName = Global.GroupName)]
